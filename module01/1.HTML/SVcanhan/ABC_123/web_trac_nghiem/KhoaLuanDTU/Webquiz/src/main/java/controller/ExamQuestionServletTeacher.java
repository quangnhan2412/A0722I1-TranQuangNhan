...
@WebServlet(name = "ExamQuestionServlet1", urlPatterns = "/teacher/examQuestion")
public class ExamQuestionServletTeacher extends HttpServlet {
...
//                break;
    ...
    private void ExamQuestionList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/teacher/exam-view.jsp");
