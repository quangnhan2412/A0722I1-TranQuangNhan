        ...
        <div class="row">
            ...
            <div class="col-10 content">
                <div class="content__title">
                    <div class="content_titlepath">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item fs-4"><a href="/teacher/exams">Danh sách đề thi</a></li>
                ...
                <div id="exam-question-list" class="user-list">
                    <form action="/teacher/examQuestion" method="post">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination pagination-sm justify-content-center">
                                        <li class="page-item ${currentPage <= 1?"disabled":""}">
                                            <c:url var="prevUrl" value="/teacher/examQuestion">
                                        ...
                                        <c:forEach var="i" begin="1" end="${maxPages}">
                                            <li class="page-item ${currentPage == i?"active":""}">
                                                <form method="post" action="/teacher/examQuestion" id="pagingForm">
                                                    <input type="hidden" name="examId" value="${examId}">
                                                    <input type="hidden" name="examName" value="${examName}">
                                                    <input type="hidden" name="subjectName" value="${subjectName}">
                                                    <input type="hidden" name="subjectId" value="${subjectId}">
                                        ...
                                        <li class="page-item ${currentPage >= maxPages?"disabled":""}">
                                            <c:url value="/teacher/examQuestion" var="nextUrl">
                                                <c:param name="index" value="${currentPage + 1}"/>
                                            </c:url>
