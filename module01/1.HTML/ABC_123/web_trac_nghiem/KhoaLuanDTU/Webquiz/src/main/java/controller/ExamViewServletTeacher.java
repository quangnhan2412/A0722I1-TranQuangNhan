...
@WebServlet(name = "ExamViewServlet1", urlPatterns = "/exam_list_teacher")
public class ExamViewServletTeacher extends HttpServlet {
    ...
    private void examList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Subject> listSubject = subjectService.selectAllSubject();
        request.setAttribute("listSubject", listSubject);
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/teacher/DanhSachDe.jsp");
        dispatcher.forward(request,response);
    }
...
//        List<Question> questionList = new ArrayList<>();
        ...
        examViewService.addHistoryExam(examId,userId,100/questionList.size() * diem, timeStart,timeEnd);
