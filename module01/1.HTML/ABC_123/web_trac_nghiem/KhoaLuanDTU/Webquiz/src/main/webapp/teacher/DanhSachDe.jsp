...
<head>
    ...
    <title>Website thi trắc nghiệm online - Đề thi môn ${listExam[0].exam.getSubject().getSubject_name()} </title>
...
<div class="container-fluid">
    <div class="container">
        <div class="row">
            ...
            <div class="col-4">
                <form id="formSJ" method="get" action="/exam_list_teacher?action=list_exam_teacher">
                            ...
                            <c:choose>
                                <c:when test="${subject.subject_name eq listExam[0].exam.getSubject().getSubject_name()}">
                                    <option value="${subject.subject_id}" selected>
                                        <a href="/exam_list_teacher?action=list_exam_teacher&sj_id=${subject.subject_id}"> ${subject.subject_name}</a>
                                    </option>
                                </c:when>
                                <c:otherwise>
                        ...
                        <div class="exam-cart__infor col-10">
                            ...
                            <div class="exam__description row">
                                ...
                                <div class="exam__start-btn">
                                    <form method="post" action="/exam_list_teacher">
                            ...
                            <c:forEach items="${list5Exam}" var="exam">
                                <li class="common-exam__item">
                                    <div class="common-exam__cart">
                                        <form action="/exam_list_teacher" method="get">
