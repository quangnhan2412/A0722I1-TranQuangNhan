...
<div class="row">
    ...
    <div class="col-3 ">
        <a href="http://localhost:8082/" class="header_logo">
    ...
    <div class="col-4" >
        <h2 style="padding-top: 140px" class="img-fluid" width="100%">
            <a href="/tComplexs?action=create" class="btn btn-success"><img src="/CSS_HomePage/img/addCustomer.jpg"></i>
                Add new Toà Nhà</a>
        </h2>
    </div>
</div>
    ...
    <div class="row searchID">
        <form  method="get" class="form-inline">
            ...
            <input type="text" class="form-control rounded " name="searchABC" placeholder="Search" aria-label="Search"
                   aria-describedby="search-addon"/>
            <button type="submit" class="btn btn-primary">Searcha</button>
        </form>
    </div>
</div>
<form action="customers" method="get">
    ...
    <table class="table table-striped" id="example">
        <caption style="caption-side: top">
            <h2 class="fw-bold">List Of Toà Nhà
            </h2>
        ...
        <c:forEach items="${complexServletsList}" var="complexServlets">
        <tr>
            <td><c:out value="${complexServlets.getToaNhaId()}"></c:out></td>
            <td><c:out value="${complexServlets.getDienTich()}"></c:out></td>
            <td><c:out value="${complexServlets.getTrangThai()}"></c:out></td>
            <td><c:out value="${complexServlets.getTang()}"></c:out></td>
            <td><c:out value="${complexServlets. getLoaiMatBang()}"></c:out></td>
            <td><c:out value="${complexServlets.getGiaTien()}"></c:out></td>
            <td><c:out value="${complexServlets.getNgayBatDau()}"></c:out></td>
            <td><c:out value="${complexServlets.getNgayKetThuc()}"></c:out></td>
            ...
            <td>
                ...
                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                        data-bs-target="#deleteModal${complexServlets.getToaNhaId()}">
                    Delete
                </button>
            </td>
            <td>
            ...
            <!-- Modal Delete -->
            <div class="modal fade" id="deleteModal${complexServlets.getToaNhaId()}" data-bs-backdrop="static"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Are you sure you want to delete <strong class="text-danger">${complexServlets.getToaNhaId()}</strong>?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <a href="/tComplexs?action=delete&id=${complexServlets.getToaNhaId()}">
